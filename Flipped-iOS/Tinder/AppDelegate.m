...
#import "ViewController.h"  // 根视图控制器
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([UserDefaults getUserDefaults:@"isLogin"]) {
        HomeViewController* vivRoot = [[HomeViewController alloc] init];
...
- (NSPersistentContainer *)persistentContainer {
    ...
    @synchronized (self) {
        if (_persistentContainer == nil) {
            _persistentContainer = [[NSPersistentContainer alloc] initWithName:@"Tinder"];
